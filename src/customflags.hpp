...
/// \brief Define parameter for facial landmarks detection model file <br>
/// It is an optional parameter
std::string fp_reid = (INTEL_CVSDK_VER == 5 ? DEFAULT_PATH + std::string("/deployment_tools/intel_models/face-reidentification-retail-0095/FP32/face-reidentification-retail-0095.xml") : DEFAULT_PATH + std::string("/deployment_tools/intel_models/face-reidentification-retail-0071/FP32/face-reidentification-retail-0071.xml"));
